...
# utp.save_temperature_time_series(dirname=dirname, dataset='p3x1', times=np.array(times), t0=t0, tmult=t0, xmult=clight/omega_p/wavelength, ymult=1, species='electrons', save_dir=save_dir, to_plot=False)
